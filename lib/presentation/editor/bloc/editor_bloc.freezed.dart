...
/// @nodoc
mixin _$EditorState {
  EditorStt get status => throw _privateConstructorUsedError;
...
abstract class $EditorStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({EditorStt status, LocationData? data});
}
...
class _$EditorStateImpl implements _EditorState {
  const _$EditorStateImpl(this.status, this.data);

  @override
  final EditorStt status;
  @override
  final LocationData? data;

  @override
  String toString() {
    return 'EditorState(status: $status, data: $data)';
  }
...
abstract class _EditorState implements EditorState {
  const factory _EditorState(final EditorStt status, final LocationData? data) =
      _$EditorStateImpl;

  @override
  EditorStt get status;
  @override
